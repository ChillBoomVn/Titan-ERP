...
// --- Text Rotation Effect for Hero Section (Đã Việt hóa cho ERP) ---
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (headline && paragraph) {
        ...
        const textSets = [{
                h1: "Quản Trị Tinh Gọn<br>Bứt Phá Doanh Thu",
                p: "NexusERP mang đến giải pháp quản trị tổng thể 'All-in-One': Từ Kho vận, Bán hàng, Nhân sự đến Tài chính. Tự động hóa quy trình để bạn tập trung vào tăng trưởng."
            },
            {
                h1: "Công Nghệ Đám Mây<br>An Toàn Tuyệt Đối",
                p: "Truy cập dữ liệu doanh nghiệp mọi lúc, mọi nơi trên mọi thiết bị. Hệ thống bảo mật đa lớp chuẩn quốc tế đảm bảo an toàn dữ liệu 100%."
            },
            {
                h1: "Dữ Liệu Thời Gian Thực<br>Ra Quyết Định Đúng",
                p: "Hệ thống báo cáo thông minh (BI) giúp chủ doanh nghiệp nắm bắt tình hình tài chính và kinh doanh tức thì, không cần chờ báo cáo cuối tháng."
            }
        ];
...
function animateCounter(element) {
    ...
    const timer = setInterval(() => {
        ...
        // Logic hiển thị phần trăm hoặc số lượng doanh nghiệp
...
// Enhanced Form submission (Đã Việt hóa thông báo)
